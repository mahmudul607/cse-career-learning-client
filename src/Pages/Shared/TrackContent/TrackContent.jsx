        ...
        <div className="max-w-screen-lx mx-auto flex rounded bg-transparent bg-[#1e203e] text-white ">
            ...
            <div className="w-1/5 fixed right-24 z-10 top-24">
                        <ul className="flex flex-col gap-2   py-6">
                           ...
                           { finalTrack ? finalTrack.paths.map(item => <Link key={item.id} rel="" type="" to={`/path/${item.id}`} className="bg-gray-700 px-2 text-sm py-2 hover:text-white customButton  rounded-r-3xl hover:border-[#f57106] border-r-4 cursor-pointer">
